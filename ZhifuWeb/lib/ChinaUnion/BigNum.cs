...
namespace ZhifuWeb.lib.ChinaUnion
{
    public class BigNum
    {
        private const UInt64 base32 = 65536ul * 65536;
        private const UInt64 base32_10 = 10000 * 100000;
        private const int wLen = 8;

        private static readonly UInt64[] baseMod = { 1, 294967296, 709551616, 543950336, 768211456, 932542976, 34512896, 610249216,
                                         129639936, 375533056, 86936576, 746218496, 990306816, 725889536, 628614656, 306290176 };

        private static readonly char[] trimZero = { '0' };
